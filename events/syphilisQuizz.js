    ...
    async execute(interaction) {
        if (interaction.isSelectMenu()) {
            ...
            switch(interaction.customId) {
            	case 'syphilis_one_first_option':
            	case 'syphilis_one_second_option':
            	case 'syphilis_one_fourth_option':
                	await interaction.reply({ embeds: [embed2], components: [row2] });
            		break;
            	case 'syphilis_one_third_option':
            		memberModel.syphilisGoodAnswers++;
                	await memberModel.save();
                	await interaction.reply({ embeds: [embed2], components: [row2] });
              	 	break;
            	case 'syphilis_two_first_option':
            	case 'syphilis_two_second_option':
            	case 'syphilis_two_third_option':
                	await interaction.reply({ embeds: [embed3], components: [row3] });
            		break;
            	case 'syphilis_two_fourth_option':
            		memberModel.syphilisGoodAnswers++;
                	await memberModel.save();
                	await interaction.reply({ embeds: [embed3], components: [row3] });
              	 	break;
            	case 'syphilis_three_first_option':
            	case 'syphilis_three_second_option':
            	case 'syphilis_three_fourth_option':
                	await interaction.reply({ embeds: [embed4], components: [row4] });
            		break;
            	case 'syphilis_three_third_option':
            		memberModel.syphilisGoodAnswers++;
                	await memberModel.save();
                	await interaction.reply({ embeds: [embed4], components: [row4] });
              	 	break;
            	case 'syphilis_four_first_option':
            	case 'syphilis_four_third_option':
            	case 'syphilis_four_fourth_option':
                	await interaction.reply({ embeds: [embed5], components: [row5] });
            		break;
            	case 'syphilis_four_second_option':
            		memberModel.syphilisGoodAnswers++;
                	await memberModel.save();
                	await interaction.reply({ embeds: [embed5], components: [row5] });
              	 	break;
            	case 'syphilis_five_second_option':
            	case 'syphilis_five_third_option':
            	case 'syphilis_five_fourth_option':
                	await interaction.reply({ embeds: [finalEmbedFail] });
            		break;
            	case 'syphilis_five_first_option':
